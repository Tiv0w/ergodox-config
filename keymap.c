...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT_ergodox(KC_EQL, KC_1, KC_2, KC_3, KC_4, KC_5, LCTL(KC_G), KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, TG(1), KC_APP, KC_A, KC_S, KC_D, KC_F, KC_G, KC_LSFT, LCTL_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_RCTL, LT(1,KC_GRV), LALT(KC_LSFT), KC_LGUI, KC_LEFT, KC_RGHT, LCTL(LSFT(KC_C)), LCTL(LSFT(KC_V)), LCTL(KC_V), KC_SPC, KC_ENT, LCTL(KC_C), KC_CAPS, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, TG(1), KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS, KC_H, KC_J, KC_K, KC_L, LT(2,KC_SCLN), LGUI_T(KC_QUOT), TG(3), KC_N, KC_M, KC_COMM, KC_DOT, RCTL_T(KC_SLSH), KC_RSFT, KC_UP, KC_DOWN, KC_LBRC, KC_RBRC, TG(1), RALT_T(KC_DEL), LCTL_T(KC_ESC), KC_LGUI, KC_RALT, TG(2), KC_BSPC),
	...
	[2] = LAYOUT_ergodox(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_WH_U, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ACL0, KC_ACL1, KC_ACL2, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2, KC_TRNS, KC_BRID, KC_INS, KC_PSCR, KC_SLCK, KC_PAUS, KC_PGUP, KC_HOME, KC_BRID, KC_TRNS, KC_TRNS, KC_UP, KC_TRNS, KC_PGDN, KC_END, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_MPLY, KC_TRNS, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, KC_TRNS, KC_VOLU, KC_VOLD, KC_MUTE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	[3] = LAYOUT_ergodox(KC_NO, KC_NO, KC_NO, XP(MY_E_HAT, MY_C_E_HAT), KC_NO, KC_NO, KC_NO, KC_NO, XP(MY_A_HAT, MY_C_A_HAT), XP(MY_E_ACUTE, MY_C_E_ACUTE), XP(MY_E_GRAVE, MY_C_E_GRAVE), XP(MY_EURO, MY_POUND), XP(MY_PI, MY_C_PI), KC_NO, KC_TRNS, XP(MY_A_GRAVE, MY_C_A_GRAVE), XP(MY_E_IN_A, MY_C_E_IN_A), XP(MY_E_TREMA, MY_C_E_TREMA), XP(MY_EPSILON, MY_C_EPSILON), XP(MY_ALPHA, MY_C_ALPHA), KC_TRNS, XP(MY_A_TREMA, MY_C_A_TREMA), XP(MY_LAMBDA, MY_C_LAMBDA), XP(MY_C_CEDILLA, MY_C_C_CEDILLA), XP(MY_OMEGA, MY_C_OMEGA), XP(MY_BETA, MY_C_BETA), KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, XP(MY_ESZETT, MY_C_ESZETT), KC_TRNS, KC_TRNS, KC_TRNS, KC_SPC, KC_ENT, KC_TRNS, KC_NO, XP(MY_Y_HAT, MY_C_Y_HAT), XP(MY_U_HAT, MY_C_U_HAT), XP(MY_I_HAT, MY_C_I_HAT), XP(MY_O_HAT, MY_C_O_HAT), KC_NO, KC_NO, KC_NO, XP(MY_GAMMA, MY_C_GAMMA), XP(MY_U_GRAVE, MY_C_U_GRAVE), XP(MY_I_GRAVE, MY_C_I_GRAVE), XP(MY_O_GRAVE, MY_C_O_GRAVE), XP(MY_E_IN_O, MY_C_E_IN_O), KC_NO, XP(MY_Y_TREMA, MY_C_Y_TREMA), XP(MY_U_TREMA, MY_C_U_TREMA), XP(MY_I_TREMA, MY_C_I_TREMA), XP(MY_O_TREMA, MY_C_O_TREMA), XP(MY_PSI, MY_C_PSI), KC_NO, KC_TRNS, XP(MY_THETA, MY_C_THETA), XP(MY_MU, MY_C_MU), XP(MY_DELTA, MY_C_DELTA), XP(MY_SIGMA, MY_C_SIGMA), XP(MY_PHI, MY_C_PHI), KC_TRNS, X(MY_LEFT_GUILLEMET), X(MY_RIGHT_GUILLEMET), KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LCTL(LSFT(KC_U)), KC_TRNS)
};
